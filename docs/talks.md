...
??? info "Augmentez votre couverture : supprimez des tests !"
    ...
    [Slides](talks/retex blackbox/slides.pdf)
...
??? info "Monades : paradigme unique pour la programation (a)synchrone"
    ...
    - [Slides](talks/monads a-sync programming/index.html)
    - [Téléchargement](https://innmind-videos.s3.fr-par.scw.cloud/afup/Afup%20Day%202023%20-%20Demo.mp4)
    - [Code](https://github.com/Baptouuuu/talks/tree/master/monads%20a-sync%20programming/demo)
...
??? info "Les Exceptions : le trou dans la raquette du typage"
    ...
    [Slides](talks/exceptions type system/index.html)
...
??? info "Du test à la preuve : introduction au Property Based Testing"
    ...
    - [Slides](talks/property based testing/slides/index.html)
    - [Code](https://github.com/Baptouuuu/talks/tree/master/property%20based%20testing/code)
...
??? info "Le temps : la dépendance oubliée"
    ...
    [Slides](talks/time dependency/index.html)

??? info "La régulation de l’activité d’une application par homéostasie"
    [Slides](talks/homeostasis/index.html)
